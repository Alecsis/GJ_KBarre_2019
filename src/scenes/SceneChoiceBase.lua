...
local function choiceChanged(self) print("Player choice changed: " .. self.playerSide) end

local function keyPressed(self, k) if k == "escape" then self.manager:load("start") end end
